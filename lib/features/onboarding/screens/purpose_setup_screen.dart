...
class PurposeSetupScreen extends ConsumerStatefulWidget {
  ...
  const PurposeSetupScreen({super.key, this.skillId});
  ...
  Future<void> _savePurpose() async {
    ...
    try {
      final purpose = Purpose(
        ...
        statement: _purposeController.text.trim(),
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                ...
                hintText:
                    'e.g., "To inspire others through my music" or "To build products that help people"',
